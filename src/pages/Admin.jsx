          ...
          {activeTab === 'master' && (
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-100 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
                 ...
                 {/* PERBAIKAN RESPONSIVE: flex-col di mobile, sm:flex-row di laptop */}
                 <form onSubmit={handleAddUnit} className="flex flex-col sm:flex-row gap-3 mb-8 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                   <input type="text" value={newUnit} onChange={e=>setNewUnit(e.target.value)} placeholder="Contoh: BRACKET" className="flex-1 border-0 bg-white shadow-sm p-3.5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#4285F4]/20 transition-all font-bold text-slate-700 uppercase" required/>
                   <button className="bg-[#1A73E8] hover:bg-[#1557B0] text-white py-3.5 sm:py-0 px-6 rounded-xl text-sm font-bold transition-colors shadow-sm shrink-0">Tambah</button>
                 </form>
               ...
               <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-100 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
                 ...
                 {/* PERBAIKAN RESPONSIVE: flex-col di mobile, sm:flex-row di laptop */}
                 <form onSubmit={handleAddTahap} className="flex flex-col sm:flex-row gap-3 mb-8 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                   <input type="text" value={newTahap} onChange={e=>setNewTahap(e.target.value)} placeholder="Contoh: TAHAP 1" className="flex-1 border-0 bg-white shadow-sm p-3.5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[#4285F4]/20 transition-all font-bold text-slate-700 uppercase" required/>
                   <button className="bg-[#1A73E8] hover:bg-[#1557B0] text-white py-3.5 sm:py-0 px-6 rounded-xl text-sm font-bold transition-colors shadow-sm shrink-0">Tambah</button>
                 </form>
